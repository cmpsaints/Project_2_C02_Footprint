$(document).ready(function() {
	...
	$("#side-menu ul.nav a[href='#beverages-listform']").on("click", function() {
		...
		if (collapsed.beverages === -1) {
			$("#side-menu ul.nav a[href='#beverages-listform'] .glyphicon.pull-right").css({
	...
	$("#side-menu ul.nav a[href='#fruitsAndVeggies-listform']").on("click", function() {
		
		if (collapsed.fruitsAndVeggies === -1) {
			$("#side-menu ul.nav a[href='#fruitsAndVeggies-listform'] .glyphicon.pull-right").css({
				"-webkit-transform": "rotate(-90deg)",
				   "-moz-transform": "rotate(-90deg)",
					"-ms-transform": "rotate(-90deg)",
					 "-o-transform": "rotate(-90deg)",
	...
	$("#side-menu ul.nav a[href='#milks-listform']").on("click", function() {
		...
		if (collapsed.milks === -1) {
			$("#side-menu ul.nav a[href='#milks-listform'] .glyphicon.pull-right").css({
				"-webkit-transform": "rotate(-90deg)",
				   "-moz-transform": "rotate(-90deg)",
					"-ms-transform": "rotate(-90deg)",
					 "-o-transform": "rotate(-90deg)",
	...
	$("#side-menu ul.nav a[href='#proteins-listform']").on("click", function() {
		...
		if (collapsed.proteins === -1) {
			$("#side-menu ul.nav a[href='#proteins-listform'] .glyphicon.pull-right").css({
				"-webkit-transform": "rotate(-90deg)",
				   "-moz-transform": "rotate(-90deg)",
					"-ms-transform": "rotate(-90deg)",
					 "-o-transform": "rotate(-90deg)",
	...
	$("#side-menu ul.nav a[href='#starches-listform']").on("click", function() {
		...
		if (collapsed.starches === -1) {
			$("#side-menu ul.nav a[href='#starches-listform'] .glyphicon.pull-right").css({
				"-webkit-transform": "rotate(-90deg)",
				   "-moz-transform": "rotate(-90deg)",
					"-ms-transform": "rotate(-90deg)",
					 "-o-transform": "rotate(-90deg)",
	...
	// ration stock stacked (layered) chart ..........
